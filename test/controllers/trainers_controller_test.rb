...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { bio: @trainer.bio, experience: @trainer.experience, first_name: @trainer.first_name, last_name: @trainer.last_name, phone: @trainer.phone, photo: @trainer.photo } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { bio: @trainer.bio, experience: @trainer.experience, first_name: @trainer.first_name, last_name: @trainer.last_name, phone: @trainer.phone, photo: @trainer.photo } }
